...
public class PrecipTypeCBDHandler implements CallbackHandlerInterface {
    ...
    public boolean canHandle(String call_data) {
        return call_data.equals("PrecipTypeCBD");
    }

    @Override
    public SendMessage handle(Update update, BotMessages botMessages, DataURLService dataURLService,
                              UserCoordinatesServiceImpl coordinatesService) {
